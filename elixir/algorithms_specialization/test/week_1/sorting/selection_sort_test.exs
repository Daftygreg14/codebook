defmodule AlgorithmsSpecialization.Week1.Sorting.SelectionSortTest do
  use ExUnit.Case, async: true
  use ExUnitProperties

  alias AlgorithmsSpecialization.Week1.Sorting.SelectionSort
